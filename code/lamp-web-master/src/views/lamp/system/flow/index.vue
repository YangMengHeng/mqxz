...
export default {
  ...
  methods:{
    async getPersonData(){
      await this.$axios.get("api/data/area/currentCount")
      .then((result) => {
      ...
      await this.$axios.get("api/data/area/dayCount")
      .then((result) => {
      ...
      await this.$axios.get("api/data/area/historyCount")
      .then((result) => {
      ...
      await this.$axios.get("api/data/area/monthCount")
      .then((result) => {
      ...
      await this.$axios.get("api/data/area/yearCount")
      .then((result) => {
...
#areaImageCard1{
  width: 100%;
  height: 100%;
  background-image: url("./area/01.jpg");
...
#areaImageCard2{
  width: 100%;
  height: 100%;
  background-image: url("./area/02.jpg");
  background-size: cover;
  background-repeat: no-repeat;
}
...
#areaImageCard3{
  width: 100%;
  height: 100%;
  background-image: url("./area/03.jpg");
  background-size: cover;
  background-repeat: no-repeat;
}
...
#areaImageCard4{
  width: 100%;
  height: 100%;
  background-image: url("./area/04.jpg");
  background-size: cover;
  background-repeat: no-repeat;
}
